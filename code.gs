...
function setupConditionSheets() {
  ...
  _ensureSheet(ss, COND_SHEETS.CARD_BASE, [
    ...
    ['shinhan','코웨이 신한카드','1833-6013','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 신한카드(신용카드) 청구 및 사용이력이 없는 고객','60개월간 최대 3만원 청구할인','','국내 27,000원 / 해외 30,000원','QR코드 또는 ☎ 1833-6013','https://shcard.io/coway'],
    ['hyundai','코웨이 현대카드','1670-0443','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 현대카드(신용카드) 청구 및 사용 이력이 없는 고객','60개월간 최대 3만원 청구할인','전국 코스트코에서 결제 가능, 애플페이 이용 가능','국내/해외 20,000원','QR코드 또는 ☎ 1670-0443',''],
    ['woori','코웨이 ICON 우리카드','1800-0859','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 우리카드(신용카드) 청구 및 사용이력이 없는 고객','60개월간 최대 3만원 청구할인','','국내/해외 25,000원','☎ 1800-0859',''],
    ['samsung','코웨이 삼성카드','1588-7540','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 삼성카드(신용카드) 청구 및 사용 이력이 없는 고객','60개월간 최대 1만 5천원 추가 청구할인','본인/가족 통신비·아파트 관리비·4대 사회보험 등 생활 요금 정기 결제 시, 결제 건별 월 1,000원(최대 3,000원) 추가 할인','국내/해외 15,000원','☎ 1588-7540',''],
    ['loca','코웨이 X LOCA (롯데카드)','1577-5208','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 롯데카드(신용카드) 청구 및 사용 이력이 없는 고객','60개월간 최대 8천원 추가 청구할인','','국내/해외 20,000원','6개월 무실적 대상 확인 및 카드 발급 페이지 · ☎ 1577-5208',''],
    ['kb','KB국민 코웨이Ⅱ카드','1644-8388','Y',36,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 KB국민카드(KB BC카드 포함) 청구 및 사용 이력이 없는 고객','36개월간 최대 3만원 청구할인','','국내/해외 30,000원','카드 신청 페이지(QR코드) · ☎ 1644-8388',''],
    ['nhbank','코웨이 NH농협카드','1644-2866','Y',60,'2026.7.1 ~ 7.31','2026년 1월~6월까지 모든 NH농협 개인 신용카드 이용실적이 없는 고객','60개월간 1만 2천원 추가 캐시백 프로모션','','국내 10,000원 / 국내외 12,000원','☎ 1644-2866','https://go.nhcard.com/GscljMo'],
  ...
  _ensureSheet(ss, COND_SHEETS.CARD_NOTE, [
    ...
    ['shinhan',2,'카드 발급 후 2026년 8월부터 카드 이용 실적 충족 및 자동납부 매출 발생 필수'],
    ['shinhan',3,'2026년 7월부터 60개월간(카드 유효기간까지) 최대 추가 11,000원 청구할인 제공'],
    ...
    ['hyundai',2,'2026년 7월 1일~7월 31일 이내 신청 접수 및 발급 확정 기준으로 혜택 적용'],
    ['hyundai',3,'카드 발급 후 2026년 8월부터 카드 이용실적 충족 및 자동납부 매출발생 필수'],
    ['hyundai',4,'2026년 8월 말까지 렌탈료 자동이체 매입 시 추가 청구할인 최대 60회 제공'],
    ['hyundai',5,'현대카드 신규 발급 고객 대상 (재발급, 기보유 회원, 해지 후 1년 미경과 회원 제외 · 본인 카드만)'],
    ['hyundai',6,'코웨이 렌탈료 면제 프로모션 고객은 면제 회차에 청구할인 혜택 미적용'],
    ['hyundai',7,'우측 QR코드 혹은 ARS 전용번호(1670-0443)로 신청 시에만 혜택 적용'],
    ['woori',1,'코웨이 렌탈/멤버십료 자동이체 필수'],
    ['woori',2,'2026년 7월 1일~7월 31일 이내 신청 접수 및 완료 기준으로 프로모션 제공'],
    ['woori',3,'2026년 9월 말까지 렌탈료 자동이체 매입 시 추가 청구할인 최대 60회 제공 (해당 월 실적 구간 미충족 시 횟수 차감)'],
    ['woori',4,'우리카드 신규/추가/교체 발급 고객 대상 (재발급, 기보유 회원, 해지 후 1년 미경과 회원 제외 · 본인 카드만)'],
    ['woori',5,'코웨이 렌탈료 면제 프로모션 고객은 면제 회차에 청구할인 혜택 미적용'],
    ['samsung',1,'코웨이 렌탈/멤버십료 자동이체 필수'],
    ['samsung',2,'카드 발급 후 2026년 8월부터 카드 이용실적 충족 및 자동납부 매출발생 필수'],
    ['samsung',3,'2026년 7월부터 60개월간(카드 유효기간까지) 최대 1만 5천원 추가 청구할인 제공'],
    ...
    ['loca',2,'카드 발급 후 2026년 8월부터 카드 이용실적 충족 및 자동납부 매출발생 필수'],
    ['loca',3,'2026년 7월부터 60개월간(카드 유효기간까지) 추가 청구할인 제공'],
    ...
    ['kb',3,'렌탈료 면제 프로모션 고객도 혜택 적용 가능 (렌탈료가 발생하는 월부터 청구할인 적용되며, 2026년 9월까지 자동납부 매출 발생 시 36개월간 적용)'],
    ['nhbank',1,'2026년 9월 내 렌탈 자동이체 매출 발생 필수'],
    ['nhbank',2,'프로모션 캐시백은 전월 실적 충족 시 제공 (단, 1회차는 미충족 시에도 제공)'],
    ['nhbank',3,'2026년 7월 내 신청된 카드만 프로모션 대상 (탈퇴 후 재발급 건 미적용 · 본인 카드만)'],
    ['nhbank',4,'코웨이 렌탈료 면제 프로모션 고객은 면제 회차에 청구할인 및 캐시백이 미적용'],
  ]);
